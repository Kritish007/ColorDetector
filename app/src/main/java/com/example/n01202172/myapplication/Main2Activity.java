    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String chkUser = username.getText().toString();
                if (chkUser.trim().equals("")) {
                    Toast.makeText(Main2Activity.this, "Please enter a username", Toast.LENGTH_LONG).show();
                    return;
                }
                String chkPass = password.getText().toString();
                if (chkPass.trim().equals("")) {
                    Toast.makeText(Main2Activity.this, "Please enter a Password", Toast.LENGTH_LONG).show();
                    return;
                }
